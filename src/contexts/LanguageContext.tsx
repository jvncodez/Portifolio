...
const translations = {
  pt: {
    ...
    certifications: {
      ...
      philosophy: {
        ...
        mission:
          "Minha missão é projetar soluções inovadoras e estruturalmente seguras, porque um barco sem casco não chega nem ao rio.",
      },
    },
    projects: {
    ...
    about: {
      title: "Sobre Mim",
      intro:
        "Sou Coordenador de Desenvolvimento e Operação com forte atuação em CyberSecurity, arquitetura de software e soluções SaaS.",
      skills:
        "Tenho experiência com Python aplicado a agentes de Inteligência Artificial, análise de vulnerabilidades, desenvolvimento backend com Node.js e TypeScript, além de integração de APIs e automações utilizando n8n e Supabase Edge Functions.",
      highlights: {
    ...
    faq: {
      ...
      items: [
        {
          q: "Quais tecnologias você utiliza para automação?",
          a: "Utilizo n8n, Python e Node.js para criar fluxos de trabalho que conectam diferentes APIs e bancos de dados.",
        },
        {
          q: "Como funciona a segurança nas suas arquiteturas?",
          a: "Implemento segurança desde o design (Security by Design), utilizando autenticação robusta e sanitização de dados.",
        },
        {
          q: "Você atua em projetos internacionais?",
          a: "Sim, possuo espanhol avançado e inglês técnico para comunicação e documentação global.",
        },
        {
          q: "Qual seu stack principal para Backend?",
          a: "Node.js (TypeScript) e Python são minhas ferramentas principais para criar APIs escaláveis.",
        },
      ],
    },
    footer: {
  ...
  en: {
    ...
    hero: {
      ...
      subtitleName: "João Silva",
      subtitlePost:
        " and I don't just implement features I design resilient structures. I architect secure systems, integrate platforms, and organize data flows with a long-term mindset.",
      cta: "View Portfolio",
    ...
    certifications: {
      ...
      philosophy: {
        ...
        mission:
          "My mission is to design innovative and structurally secure solutions, because a boat without a hull won't even reach the river.",
      },
    },
    projects: {
    ...
    about: {
      title: "About Me",
      intro:
        "I'm a Development and Operations Coordinator with strong expertise in CyberSecurity, software architecture, and SaaS solutions.",
      skills:
        "I have experience with Python for AI agents, vulnerability analysis, backend development with Node.js and TypeScript, plus API integrations and automations using n8n and Supabase Edge Functions.",
      highlights: {
        security: "CyberSecurity",
        backend: "Backend",
    ...
    faq: {
      ...
      items: [
        {
          q: "What technologies do you use for automation?",
          a: "I use n8n, Python, and Node.js to create workflows that connect different APIs and databases.",
        },
        {
          q: "How does security work in your architectures?",
          a: "I implement Security by Design, using robust authentication and data sanitization.",
        },
        {
          q: "Do you work on international projects?",
          a: "Yes, I have advanced Spanish and technical English for global communication and documentation.",
        },
        {
          q: "What is your main Backend stack?",
          a: "Node.js (TypeScript) and Python are my main tools for creating scalable APIs.",
        },
      ],
    },
    footer: {
  ...
  es: {
    ...
    hero: {
      ...
      subtitleName: "João Silva",
      subtitlePost:
        " y no solo implemento funcionalidades diseño estructuras resilientes. Diseño arquitecturas seguras, integro sistemas y organizo flujos de datos con mentalidad a largo plazo.",
      cta: "Ver Portafolio",
      experience: "Años Exp.",
    },
    services: {
    ...
    certifications: {
      ...
      items: [
        ...
        { category: "JavaScript", items: ["Intensivo de JavaScript – Hashtag Treinamentos"] },
        {
          ...
          items: ["Automatización con Arduino y ESP32 – Crescer Industria de Automatización"],
        },
      ...
      philosophy: {
        ...
        mission:
          "Mi misión es diseñar soluciones innovadoras y estructuralmente seguras, porque un barco sin casco no llega ni al río.",
      },
    },
    projects: {
    ...
    about: {
      title: "Sobre Mí",
      intro:
        "Soy Coordinador de Desarrollo y Operación con fuerte actuación en Ciberseguridad, arquitectura de software y soluciones SaaS.",
      skills:
        "Tengo experiencia con Python aplicado a agentes de Inteligencia Artificial, análisis de vulnerabilidades, desarrollo backend con Node.js y TypeScript, además de integración de APIs y automatizaciones usando n8n y Supabase Edge Functions.",
      highlights: {
    ...
    faq: {
      ...
      items: [
        {
          q: "¿Qué tecnologías usas para automatización?",
          a: "Uso n8n, Python y Node.js para crear flujos de trabajo que conectan diferentes APIs y bases de datos.",
        },
        {
          q: "¿Cómo funciona la seguridad en tus arquitecturas?",
          a: "Implemento Seguridad por Diseño, usando autenticación robusta y sanitización de datos.",
        },
        {
          q: "¿Trabajas en proyectos internacionales?",
          a: "Sí, tengo español avanzado e inglés técnico para comunicación y documentación global.",
        },
        {
          q: "¿Cuál es tu stack principal para Backend?",
          a: "Node.js (TypeScript) y Python son mis herramientas principales para crear APIs escalables.",
        },
      ],
    },
    footer: {
      description:
        "Diseñando el futuro de la tecnología con arquitectura sólida, automatización inteligente y seguridad total.",
